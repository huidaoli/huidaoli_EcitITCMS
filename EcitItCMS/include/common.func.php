...
/**
 * 系统核心函数存放文件
 * @version        $Id: common.func.php 4 16:39 2010年7月6日Z tianya $ * @package        EcitITCMS.Libraries
...
function ShowMsg($msg, $gourl, $onlymsg=0, $limittime=0)
{
    ...
    else
    {
      ...
      function JumpUrl(){
        ...
        $rmsg .= "<div style='padding:6px;font-size:12px;border-bottom:1px solid #DADADA;background:#DBEEBD url({$GLOBALS['cfg_plus_dir']}/img/wbg.gif)';'><b>EcitITCMS 提示信息！</b></div>\");\r\n";
