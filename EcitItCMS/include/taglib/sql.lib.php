 ...
 * SQL标签
 *
 * @version        $Id: sql.lib.php 2 10:00 2010-11-11 tianya $ * @package        EcitITCMS.Taglib
...
<attributes>
    ...
    <iterm>appname: 默认为default,即当前EcITCMS的数据库,如果需要自定义,可以在data/tag/sql.inc.php中扩展,具体扩展方法查看配置文件头部说明</iterm>
</attributes>
>>dede>>*/
