<?php
/**
 * @version        $Id: index_do.php 1 8:24 2010年7月9日Z tianya $ * @package        EcitITCMS.Member
                ...
                if(!$rs) {
                    ...
                    if($res) {
                       ...
                       `drink`='0', `datingtype`='0', `language`='', `nature`='', `lovemsg`='', `address`='',`uptime`='0';",
                        ...
                        3 => "INSERT INTO `#@__member_flink` SET `mid`='$mid', `title`='东理IT内容管理系统', `url`='http://www.ecit-it.com';"
                        );                        
