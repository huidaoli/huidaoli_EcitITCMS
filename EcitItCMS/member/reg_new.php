<?php
/**
 * @version        $Id: reg_new.php 1 8:38 2010年7月9日Z tianya $ * @package        EcitITCMS.Member
    ...
    if($dopost=='regbase')
    {
       ...
       '0','$spaceSta','','$safequestion','$safeanswer','$jointime','$joinip','$logintime','$loginip'); ";
        if($dsql->ExecuteNoneQuery($inQuery))
        {
            ...
            //写入其它默认数据
            $dsql->ExecuteNoneQuery("INSERT INTO `#@__member_flink`(mid,title,url) VALUES('$mid','东理IT内容管理系统','http://www.ecit-it.com'); ");
            ...
            if($cfg_mb_spacesta==-10)
            {
                ...
                $mailbody .= "{$url}\r\n\r\n";
                $mailbody .= "Power by http://www.ecit-it.com 东理IT内容管理系统！\r\n";
