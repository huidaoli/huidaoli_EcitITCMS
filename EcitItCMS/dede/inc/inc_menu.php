...
<m:top item='1_10_7_' name='系统帮助' display='none'>
  <m:item name='参考文档' link='http://www.ecit-it.com' rank='' target='_blank' />
  <m:item name='意见建议反馈' link='http://www.ecit-it.com/plus/guestbook.php' rank='' target='_blank' />
  <m:item name='官方交流论坛' link='http://www.ecit-it.com' rank='' target='_blank' />
</m:top>
